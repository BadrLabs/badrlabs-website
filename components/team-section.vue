  ...
  <section id="team-section" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        ...
        >
          ...
          <div class="p-6">
            ...
            <p class="text-orange-600 font-semibold mb-3">{{ member.role }}</p>
            ...
            <div class="flex flex-wrap gap-2">
              <span 
                ...
                :key="skill"
                class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full hover:bg-orange-100 hover:text-orange-700 transition-all duration-300"
              >
                {{ skill }}
              </span>
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="text-center p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 hover:from-orange-100 hover:to-orange-200 transition-all duration-300 hover:scale-105 group">
          <div class="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
...
const teamMembers = [
  {
    ...
    bio: 'A seasoned developer with 8+ years of experience, specializing in building high-performance, user-focused applications. Experienced in leading teams, mentoring developers, and driving projects from concept to delivery.',
  ...
  },
  {
    ...
    bio: 'A versatile engineer who specializes in Agentic AI systems, with a background in technical project management. Holds degrees in Mechatronics Engineering (BASc) and Biomedical Engineering (MASc), and has experience leading multi-million-dollar projects.',
  ...
  },
  {
    name: 'Omar Irfan',
    role: 'Full Stack Developer',
    bio: 'A driven craftsman with 5+ years of experience. He delivers fast, accessible applications that align closely with real business needs, while crafting polished and intuitive user experiences that engage and delight.',
  ...
  },
  {
    ...
    bio: 'A passionate builder with 5+ years of experience, builds high-performance API services, cloud infrastructure, and data pipelines, with a focus on delivering scalable, reliable, and seamless digital experiences.',
